...
class OCDI_Demo_Importer {
    ...
    public function __construct() {
        ...
        add_action( 'init', [$this, 'karx_toolkit_rewrite_flush'] );
    }
    ...
    public function import_files_config() {
		...
		$home_prevs = array(
			'karx_home_1' => array(
				'title' => __( 'Home 1', 'karx' ),
				'page'  => __( 'home', 'karx' ),
				'screenshot' => get_template_directory_uri().'/inc/img/ocdi/home-1.jpg',
				'preview_link' => 'https://themephi.net/wordpress/karx/',
			)
		);
		$home_prevs = array(
			'karx_home_2' => array(
				'title' => __( 'Home 2', 'karx' ),
				'page'  => __( 'home-2', 'karx' ),
				'screenshot' => get_template_directory_uri().'/inc/img/ocdi/home-2.jpg',
				'preview_link' => 'https://themephi.net/wordpress/karx/home-2/',
			)
		);
        ...
        foreach ( $home_prevs as $key => $prev ) {
            ...
            $config[] = [
                ...
                'import_notice'                => esc_html__( 'After you import this demo, you will have to setup the slider separately.', 'karx' ),
            ];
        }
    ...
    public function karx_toolkit_rewrite_flush() {
