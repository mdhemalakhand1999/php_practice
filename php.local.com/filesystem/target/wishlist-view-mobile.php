...
<div class="row">
    <div class="col-12">
        <div class="karx-shopping-cart-table karx-has-cart-wishlist">
            <table class="table cart wishlist_table wishlist_view traditional responsive <?php echo esc_attr($no_interactions) ? esc_attr__('no-interactions', 'karx') : __('', 'karx'); ?> <?php echo esc_attr($enable_drag_n_drop) ? esc_html__('sortable', 'karx') : __('', 'karx'); ?> " data-pagination="<?php echo esc_attr( $pagination ); ?>" data-per-page="<?php echo esc_attr( $per_page ); ?>" data-page="<?php echo esc_attr( $current_page ); ?>" data-id="<?php echo esc_attr( $wishlist_id ); ?>" data-token="<?php echo esc_attr( $wishlist_token ); ?>">
            <?php $column_count = 2; ?>
                <thead>
                    <tr>
                    <?php if ( $show_cb ) : ?>
                    ...
                    <?php endif; ?>
                        <th>
                            <?php
                                 ...
                                 * @return string
                                 */
                                echo esc_html( apply_filters( 'yith_wcwl_wishlist_view_name_heading', __( 'Product', 'karx' ), $wishlist ) );
                            ?>
                        </th>
                        <?php if ( $show_price || $show_price_variations ) : ?>
                            ...
                            <th>
                                 ...
                                 * @return string
                                 */
                                echo esc_html( apply_filters( 'yith_wcwl_wishlist_view_price_heading', __( 'price', 'karx' ), $wishlist ) );
                                ?>
                            </th>
                        <?php endif; ?>
                        <?php if ( $show_quantity ) : ?>
                            ...
                            <th>
                                 ...
                                 * @return string
                                 */
                                echo esc_html( apply_filters( 'yith_wcwl_wishlist_view_quantity_heading', __( 'Quantity', 'karx' ), $wishlist ) );
                                ?>
                            </th>
                        <?php endif; ?>
                        <?php if ( $show_stock_status ) : ?>
                            ...
                            <th class="product-stock-status">
                                 ...
                                 * @return string
                                 */
                                echo esc_html( apply_filters( 'yith_wcwl_wishlist_view_stock_heading', __( 'Stock status', 'karx' ), $wishlist ) );
                                ?>
                            </th>
                        <?php endif; ?>
                        <?php if ( $show_last_column ) : ?>
                            ...
                            <th class="product-add-to-cart">
                                 ...
                                 * @return string
                                 */
                                echo esc_html( apply_filters( 'yith_wcwl_wishlist_view_cart_heading', 'Add Cart', $wishlist ) );
                                ?>
                            </th>
                    <?php endif; ?>
                        ...
                        ?>
                             ...
                             * @return string
                             */
                            echo esc_html( apply_filters( 'yith_wcwl_wishlist_view_remove_heading', 'Action', $wishlist ) );
                            ?>
                            </th>
                        <?php endif; ?>
                        ...
                        <?php $column_count ++; ?>
                            <th class="product-arrange">
                                 ...
                                 * @return string
                                 */
                                echo esc_html( apply_filters( 'yith_wcwl_wishlist_view_arrange_heading', __( 'Arrange', 'karx' ), $wishlist ) );
                                ?>
                            </th>
                        <?php endif; ?>
                    </tr>
                        ...
                        ?>
                            <?php if ( $product && $product->exists() ) : ?>
                                <tr id="yith-wcwl-row-<?php echo esc_attr( $item->get_product_id() ); ?>" data-row-id="<?php echo esc_attr( $item->get_product_id() ); ?>">
                                    ...
                                    <?php endif ?>
                                    <td>
                                        <div class="karx-shopping-cart-product-box">
                                            <?php
                                                /**
                                    ...
                                    <?php if ( $show_price || $show_price_variations ) : ?>
                                    <td>
                                        <div class="karx-product-cart-price">
                                            <span>
                                                <?php
                                                    /**
                                    ...
                                    <?php if ( $show_stock_status ) : ?>
                                        <td class="product-stock-status">
                                            ...
                                            * @return string
                                            */
                                            echo 'out-of-stock' === $item->get_stock_status() ? '<span class="wishlist-out-of-stock">' . esc_html( apply_filters( 'yith_wcwl_out_of_stock_label', __( 'Out of stock', 'karx' ) ) ) . '</span>' : '<span class="wishlist-in-stock">' . esc_html( apply_filters( 'yith_wcwl_in_stock_label', __( 'In Stock', 'karx' ) ) ) . '</span>';
                                            ?>
                                        ...
                                        <td class="product-add-to-cart">
                                            ...
                                            */
                                            ...
                                            if ( $show_dateadded && $item->get_date_added() ) :
                                                ...
                                                echo '<span class="dateadded">' . esc_html( sprintf( __( 'Added on: %s', 'karx' ), $item->get_date_added_formatted() ) ) . '</span>';
                                            endif;
                                            ?>
                                            ...
                                            */
                                            ...
                                            <?php if ( $move_to_another_wishlist && $available_multi_wishlist && count( $users_wishlists ) > 1 ) : ?>
                                                <?php if ( 'select' === $move_to_another_wishlist_type ) : ?>
                                                    <select class="change-wishlist selectBox">
                                                        <option value=""><?php esc_html_e( 'Move', 'karx' ); ?></option>
                                                        <?php
                                                ...
                                                <?php else : ?>
                                                    <a href="#move_to_another_wishlist" class="move-to-another-wishlist-button" data-rel="prettyPhoto[move_to_another_wishlist]">
                                                        ...
                                                        * @return string
                                                        */
                                                        echo esc_html( apply_filters( 'yith_wcwl_move_to_another_list_label', __( 'Move to another list &rsaquo;', 'karx' ) ) );
                                                        ?>
                                                    </a>
                                                <?php endif; ?>
                                            ...
                                            if ( $repeat_remove_button ) :
                                                ...
                                                */
                                                ?>
                                                <a href="<?php echo esc_url( $item->get_remove_url() ); ?>" class="remove_from_wishlist button" title="<?php echo esc_html( apply_filters( 'yith_wcwl_remove_product_wishlist_message_title', __( 'Remove this product', 'karx' ) ) ); ?>"><?php esc_html_e( 'Remove', 'karx' ); ?></a>
                                            <?php endif; ?>
                                        ...
                                        <td class="product-remove">
                                            <div>
                                                <?php
                                                     ...
                                                     */
                                                ?>
                                                <a href="<?php echo esc_url( $item->get_remove_url() ); ?>" class="karx-cart-times-btn remove remove_from_wishlist" title="<?php echo esc_html( apply_filters( 'yith_wcwl_remove_product_wishlist_message_title', __( 'Remove this product', 'karx' ) ) ); ?>"><i class="fal fa-times"></i></a>
                                            </div>
                                        </td>
                                    <?php endif; ?>
                                </tr>
