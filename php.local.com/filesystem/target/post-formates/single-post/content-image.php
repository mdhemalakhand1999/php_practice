<?php $tp_toolkit_blog_date_switch = get_theme_mod('tp_toolkit_blog_date_switch', true); ?>
<article id="post-<?php the_ID(); ?>" <?php post_class('single-blog mb-80 content-image'); ?>>
