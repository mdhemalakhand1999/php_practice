...
if ( '0' === $comment->comment_approved ) { ?>
	...
	<p class="meta">
		<em class="woocommerce-review__awaiting-approval">
			<?php esc_html_e( 'Your review is awaiting approval', 'karx' ); ?>
		</em>
	</p>

<?php } else { ?>

	<div class="reviewer-info mb-10">
		<h4 class="woocommerce-review__author title"><?php comment_author(); ?> </h4>
		<?php
		if ( 'yes' === get_option( 'woocommerce_review_rating_verification_label' ) && $verified ) {
			echo '<em class="woocommerce-review__verified verified">(' . esc_attr__( 'verified owner', 'karx' ) . ')</em> ';
		}

		?>
        <div class="review-date mb-10">
